;(function ($, window, document, undefined) {
	...
	var defaults = {
			...
			exportingAdditionalInformation: false,
			allowOption: false,
			daysList: [
				'Monday',
				'Tuesday',
			...
			onPeriodDragged: function () {
			},
			onPeriodResized: function () {
			},
			onBeforeRemovePeriod: function () {
			},
	...
	$.extend(Plugin.prototype, {
		...
		remove: function (period) {
			if (!this.settings.onBeforeRemovePeriod.call(this, period, this.element)) {
				period.remove();
				this.closeOptions();
				this.settings.onAfterRemovePeriod.call(this, period, this.element)
			}
		},
		...
		periodData: function (period) {
			...
			if (this.settings.exportingAdditionalInformation) {
				exportedObject = Object.assign({}, exportedObject, {
